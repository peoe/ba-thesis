...
This introductory part will follow~\cite{San2015}, Chapter~1, closely in content as well as notation. It will contain the Monge and Kantorovich formulations of the optimal transport problem, as well as a dual problem for the Kantorovich problem.
...
We can already provide a couple of results about the existence of transport maps --- though these must not be optimal for (MP).
...
This concludes the first part, having laid out a foundation for the theory of optimal transport. The focus will now turn towards applying the duality and existence results in order to investigate large-scale optimal transport solutions.