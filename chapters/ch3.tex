...
\begin{lemma}[Adapted from~\cite{San2015}, Theorem~1.7]\label{KPAdmitPolishLSC}
...
\begin{proof}
	...
	With Prokhorov we have \weak{\gamma_n}{\gamma}. As our transport plan $\gamma$ was arbitrarily chosen, this property holds for all transport plans and thus all sequences of transport plans. The claim can be seen using the compactness of \TP{\mu}{\nu} and the continuity of $K$ with regard to the weak convergence of measures.
\end{proof}
