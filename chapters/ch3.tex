...
This problem in general is not easy to solve. In order to point out the difficulites we may face, we require the notions of the \textit{weak convergence} and the \textit{support} of a function.
...
As~\cite{San2015}, Section~1.2, points out, the problem (KP) is a linear problem with convex constraints. Hence, it is plausible to investigate the \textit{dual problem}. 
