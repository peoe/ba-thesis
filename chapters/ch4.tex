...
\begin{proof}
	\todoinline{TODO:~Add outline why we only have to show the following and properly introduce our $f$! Also add notice for $K_g$ as the Lipschitz constant of $g$!}
	...
	Choosing $\varepsilon = \lambda_{c_n, \mu_n, \nu_n} \cdot \ln\left( n^2 \Vert Y \vert^{1/2}_{\R^{n \times d}, 2} M_{c_n, \mu_n, \nu_n} \right)^{-1}$ suffices for the right hand side to converge to $0$ for any Lipschitz continuous $g$ over $\Omega$, showing \weak[]{\bar{\gamma}_n^{\varepsilon_n}}{f} for \Ninf.
\end{proof}
