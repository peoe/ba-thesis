...
We first give a basic overview on \textit{neural networks}. This will be based on\ \cite{Good2016}, Chapter~6, and\ \cite{Brag2020}, Section~6.2.
...
When $\mu$ and $\nu$ are discrete, the resulting dual variables are simply vectors, for the continuous case however, they have to be modelled by the previously mentioned neural networks.

\todoinline{TODO:~better tie in to the previous sections!}
