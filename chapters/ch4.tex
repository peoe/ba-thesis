...
weakly converging to $\mu \in \LLL[\Omega_1]$ and $\nu \in \LLL[\Omega_2]$ for $x_i \in \Omega_1, y_j \in \Omega_2, 1 \le i, j \le n$, respectively.
...
\todoinline{TODO:~work towards~\cite{San2015}, Theorem~2}