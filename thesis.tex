...
\newcommand{\push}[2][T]{\ensuremath{{#1}_{\#} #2}}
...
\newcommand{\D}[1][\mu]{\ensuremath{\text{d}{#1}}}
\newcommand{\Dx}[2][x]{\ensuremath{\text{d}{#2}({#1})}}
\newcommand{\CConc}[1]{\ensuremath{c-conc(#1)}}
\newcommand{\CBConc}[1]{\ensuremath{\bar{c}-conc(#1)}}
