...
\hyphenation{iteration}
\hyphenation{instead}
\hyphenation{parameters}
\hyphenation{regularized}
\hyphenation{generative}
...
\hypersetup{
    ...
    urlcolor=blue,
    bookmarksopen=true,
    pdftitle={Optimal Transport and Large-Scale Mapping Estimation}
}
% \hypersetup{
%     colorlinks=true,
%     linkcolor=black,
...
\author{Peter Bernd Oehme \\[1cm]{\small Supervisor: Professor Dr.\ Jan-Frederik Pietschmann}}
\date{15 July 2021}
